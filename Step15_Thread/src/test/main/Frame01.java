...
/*
 * java 에서의 하나의 스레드만 사용하는 것은
 * 여러분이 카페에 갔는데 일하는 직원이 1명
 * 그 직원이 이렇게 일한다
 * 주문을 받으면 해당 메뉴를 준비하고 그 메뉴가 다 만들어질때까지 다음 주문을 받지 않는다.
 */

/*
 * java 에서 여러개의 스레드를 사용한다는 것은
 * 여러분이 카페에 갔을 때 갑자기 일하는 직원이 한명 생긴다.
 * 그 직원은 여러분의 주문을 받고 그 메뉴를 준비한다.
 */
